...
function addSongsToDiv(WHICH_DIV, sortinfo) {
    ...
    for (let i = 1; i < ITERS; i++) {
        ...
        const SINGLE_INSTANCE_CONTAINER = nullPrefix + 'div'+IDX++;
        addElement(ALL_INSTANCES_CONTAINER, 'div', SINGLE_INSTANCE_CONTAINER, '');

        const SPECIFIC_SORT_LABEL = nullPrefix + 'p'+IDX++;
        ...
        const ALL_SONGS_CONTAINER = nullPrefix + 'div'+IDX++;
        ...
        allSongs.forEach(song => {
            if (!(ordercodeidx == 'x') && song.infocode[ordercodeidx] != currentInstance.ordercode) ;
                ...
                const SINGLE_SONG_CONTAINER = idPrefix + 'SSC' + IDX++;
                addElement(ALL_SONGS_CONTAINER, 'div', SINGLE_SONG_CONTAINER, '');
                
                const SONG_CIRCLES_CONTAINER_1 = idPrefix + 'SCC1' + IDX++;
                const SONG_CIRCLES_CONTAINER_2 = idPrefix + 'SCC2' + IDX++;
                const SONG_CIRCLES_CONTAINER_3 = idPrefix + 'SCC3' + IDX++;
                const SONG_CIRCLES_CONTAINER_4 = idPrefix + 'SCC4' + IDX++;
                const SONG_CIRCLES_CONTAINER_5 = idPrefix + 'SCC5' + IDX++;
                ...
                const SONG_TITLE_LABEL = idPrefix + 'STL' + IDX++;
                const SONG_DURATION_LABEL = idPrefix + 'SDL' + IDX++;
...
function playPreviousSong() {
    ...
    AUDIOSRC.attr('src', newSong.src);
    AUDIO.load();
    AUDIO.play();

    CURRENT_SONG_IDX = newIdx;
}
